...
namespace WindowsFormsAppGM23
{
    public partial class FormMateriel : Form
    {
        ...
        {
            string nom_modele = textBoxModele.Text;
            string strsql = "delete from Materiel where Nom_modele= '" + nom_modele + "'";
            ...
            {
                MessageBox.Show("Suppression impossible car le matériel est présente dans une intervention",
